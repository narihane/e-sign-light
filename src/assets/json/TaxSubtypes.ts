import { SubTaxFields } from 'src/app/shared/_models/tax.model';

export let tax_sub_codes: SubTaxFields[] = [
  {
    Code: 'V001',
    Desc_en: 'Export',
  ...
  },
  {
    Code: 'W005',
    Desc_en:
      'Sumspaid by the cooperative societies for car transportation to their members',
  ...
  },
  {
    Code: 'W007',
    Desc_en:
      'Discounts& grants & additional exceptional incentives granted by smoke &cement companies',
    Desc_ar:
      'الخصوماتوالمنح والحوافز الاستثنائية ةالاضافية التي تمنحها شركات الدخان والاسمنت ',
    TaxtypeReference: 'T4',
  },
  {
    Code: 'W008',
    Desc_en:
      'Alldiscounts & grants & commissions granted by petroleum &telecommunications & other companies',
    Desc_ar:
      'جميعالخصومات والمنح والعمولات  التيتمنحها  شركات البترول والاتصالات ...وغيرها من الشركات المخاطبة بنظام الخصم',
    TaxtypeReference: 'T4',
  },
  {
    Code: 'W009',
